                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form method="POST" action="{{ route('userprofile') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <div class="pt-2">
                                                <div class="d-flex gap-2">
                                                    <input type="file" id="file" name="file" class="mb-2 flex-1">
                                                    <label for="file" class="btn btn-primary btn-sm text-white"
